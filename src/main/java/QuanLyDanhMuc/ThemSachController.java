...
//		if((Name!=null) and ()) {}
		Sach sach = new Sach(Name, Price, Image, CategoryId, PublisherId, AuthorId, PublishYear, TotalPage, Language,
				Description);
//		if (sach.equals(sach)){
//			response.sendRedirect("TrangQuanTriVien/ThemSach.jsp");
//		} 

			try {
				sachDbUtil.ThemSach(sach);
