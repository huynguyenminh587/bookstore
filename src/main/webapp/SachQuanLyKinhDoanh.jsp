...
<link rel="stylesheet" type="text/css" href="css/SachKinhDoanh.css" />
			...
			<div class="menu_right">
				...
				<ul>
					...
					<li><a href="DanhMucSachController?param=3"
						title="Sách quản lý kinh doanh" class="active">Sách quản
							lý-kinh doanh</a></li>
					<li><a href="DanhMucSachController?param=4"
						title="Sách kiến thức bách khoa">Sách kiến thức bách khoa</a></li>
