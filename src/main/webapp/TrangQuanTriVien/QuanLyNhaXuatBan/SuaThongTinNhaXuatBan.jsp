...
<body>
<script type="text/javascript" src="../../JavaScript/ThemSuaXoa.js"></script>
	<div class="admin">
	...
	<div class="right">
		<div class="header">
			<h3>Sửa thông tin nhà xuất bản</h3>
		</div>
		<form action="../../LayDuLieuThemSuaXoaNhaXuatBan" method="get" name="ThemTacGia" onsubmit="return kiemtra()">
			<table> 
				<tbody>
					...
					<tr>
						<td><label>NamePublisher: <%=request.getParameter("NamePublisher")%></label></td>
					</tr>
					<tr>
						<td><input type="text" name="NamePublisher" value="<%=request.getParameter("NamePublisher")%>"></td>
					</tr>

					<tr>
						<td><label>Address: <%=request.getParameter("Address") %></label></td>
					</tr>
					<tr>
			...
			<input type="hidden" value="sua" name="ten">
