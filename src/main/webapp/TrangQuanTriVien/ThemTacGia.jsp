...
<body>
<script type="text/javascript" src="../JavaScript/ThemTacGia.js">
	...
	<div class="right">
		...
		<form action="../ThemHoacXoaTacGiaController" method="get" name="ThemTacGia" onsubmit="return kiemtra()">
			<table>
				<tbody>


					<tr>
						<td><label>NameAuthor:</label></td>
						<td><input type="text" name="NameAuthor" id="NameAuthor"></td>
					</tr>
